...
bucket_gs = client.get_bucket('shan_movie_bucket')
blob = bucket_gs.get_blob('comedy_movie_sp.bql')
sql_stmt = blob.download_as_string()
...
with DAG('comedy_movie_v2_process',default_args=default_DAG_args, catchup=False) as dag:
